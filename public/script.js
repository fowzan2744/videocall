window.addEventListener('DOMContentLoaded', () => {
  ...
  if (muteButton) {
    muteButton.addEventListener('click', () => {
      if (myStream) {
        ...
        // Toggle Tailwind classes explicitly
        if (isMuted) {
          muteButton.classList.add('bg-red-600', 'hover:bg-red-700');
          muteButton.classList.remove('bg-red-500', 'hover:bg-red-600');
        } else {
          muteButton.classList.add('bg-red-500', 'hover:bg-red-600');
  ...
  if (pauseButton) {
    pauseButton.addEventListener('click', () => {
      if (myStream) {
        ...
        if (isVideoOff) {
          pauseButton.classList.add('bg-gray-600', 'hover:bg-gray-700');
          pauseButton.classList.remove('bg-blue-500', 'hover:bg-blue-600');
        } else {
          pauseButton.classList.add('bg-blue-500', 'hover:bg-blue-600');
          pauseButton.classList.remove('bg-gray-600', 'hover:bg-gray-700');
        }
    ...
    screenShareButton.addEventListener('click', async () => {
      if (!isScreenSharing) {
        try {
          ...
          screenShareButton.classList.add('bg-orange-600', 'hover:bg-orange-700');
  ...
  function stopScreenShare() {
    if (myStream) {
      ...
      screenShareButton.classList.remove('bg-orange-600', 'hover:bg-orange-700');
    }
  }
